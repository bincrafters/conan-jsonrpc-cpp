...
static void udp_server_service() {
    TestRpc a;
...
static void udp_client_service() {
 ...
 */
int main() {
    std::thread server(udp_server_service);
    std::this_thread::sleep_for(std::chrono::seconds(1));
    std::thread client(udp_client_service);
